...
- **Đa nền tảng**: Hỗ trợ cả iOS và Android (React Native)
- **Voice Interface**: Ghi âm và tương tác giọng nói trực tiếp
- **Real-time communication**: Tương tác thời gian thực qua Socket.IO

- **Modern UI**: Giao diện mượt mà với React Native Reanimated
